...
```
Da qui il progetto ha preso la sua direzione cercando un'interazione nuova capace di rendere migliore ed ancora più unica l'esperienza del Theremin: oltre alla rappresentazione visiva, la possibilità di poter suonare con due oscillatori differenti contemporaneamente è la parte centrale del codice.
...
Un ipotetico target del progetto sono musicisti, appassionati, curiosi che vogliono provare ad avvicinarsi al mondo del Theremin. Come contesto d'uso il progetto potrebbe essere utile per un concerto in quanto offre una esperienza visiva che può coinvolgere molto il pubblico. Data la facilità nel poter suonare lo strumento in maniera virtuale può anche essere sperimentato in centri per disabili, utile ad affinare il concetto di movimento e far divertire in maniera diversa le persone più fragili. 

## Immagini e video

[<img src="src/immagini-video/immagine1.jpeg" width="100%" alt="Foto del progetto 1">]()

[<img src="src/immagini-video/immagine2.jpeg" width="100%" alt="Foto del progetto 2">]()

[<img src="src/immagini-video/immagine3.jpeg" width="100%" alt="Foto del progetto 3">]()
